...
%ReswarmTestNumber gives an empty data for reswarm_msgs_matlab/ReswarmTestNumber
% Copyright 2019-2020 The MathWorks, Inc.
%#codegen
data = struct();
data.MessageType = 'reswarm_msgs_matlab/ReswarmTestNumber';
...
info.MessageType = 'reswarm_msgs_matlab/ReswarmTestNumber';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
