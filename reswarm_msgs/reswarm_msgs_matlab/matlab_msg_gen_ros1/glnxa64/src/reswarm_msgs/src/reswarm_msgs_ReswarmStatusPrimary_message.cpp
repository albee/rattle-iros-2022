...
// Common copy functions for reswarm_msgs/ReswarmStatusPrimary
...
class RESWARM_MSGS_EXPORT reswarm_msgs_msg_ReswarmStatusPrimary_common : public MATLABROSMsgInterface<reswarm_msgs::ReswarmStatusPrimary> {
  public:
    virtual ~reswarm_msgs_msg_ReswarmStatusPrimary_common(){}
    virtual void copy_from_struct(reswarm_msgs::ReswarmStatusPrimary* msg, const matlab::data::Struct& arr, MultiLibLoader loader); 
    //----------------------------------------------------------------------------
    virtual MDArray_T get_arr(MDFactory_T& factory, const reswarm_msgs::ReswarmStatusPrimary* msg, MultiLibLoader loader, size_t size = 1);
};
  void reswarm_msgs_msg_ReswarmStatusPrimary_common::copy_from_struct(reswarm_msgs::ReswarmStatusPrimary* msg, const matlab::data::Struct& arr,
  ...
  //----------------------------------------------------------------------------
  MDArray_T reswarm_msgs_msg_ReswarmStatusPrimary_common::get_arr(MDFactory_T& factory, const reswarm_msgs::ReswarmStatusPrimary* msg,
    ...
    outArray[ctr]["MessageType"] = factory.createCharArray("reswarm_msgs/ReswarmStatusPrimary");
    // stamp
...
class RESWARM_MSGS_EXPORT reswarm_msgs_ReswarmStatusPrimary_message : public ROSMsgElementInterfaceFactory {
  public:
    virtual ~reswarm_msgs_ReswarmStatusPrimary_message(){}
    virtual std::shared_ptr<MATLABPublisherInterface> generatePublisherInterface(ElementType type);
    virtual std::shared_ptr<MATLABSubscriberInterface> generateSubscriberInterface(ElementType type);
};  
  std::shared_ptr<MATLABPublisherInterface> 
          reswarm_msgs_ReswarmStatusPrimary_message::generatePublisherInterface(ElementType type){
    if(type != eMessage){
        throw std::invalid_argument("Wrong input, Expected eMessage");
    }
    return std::make_shared<ROSPublisherImpl<reswarm_msgs::ReswarmStatusPrimary,reswarm_msgs_msg_ReswarmStatusPrimary_common>>();
  }
  std::shared_ptr<MATLABSubscriberInterface> 
         reswarm_msgs_ReswarmStatusPrimary_message::generateSubscriberInterface(ElementType type){
    if(type != eMessage){
        throw std::invalid_argument("Wrong input, Expected eMessage");
    }
    return std::make_shared<ROSSubscriberImpl<reswarm_msgs::ReswarmStatusPrimary,reswarm_msgs::ReswarmStatusPrimary::ConstPtr,reswarm_msgs_msg_ReswarmStatusPrimary_common>>();
  }
#include "class_loader/register_macro.hpp"
// Register the component with class_loader.
// This acts as a sort of entry point, allowing the component to be discoverable when its library
// is being loaded into a running process.
CLASS_LOADER_REGISTER_CLASS(reswarm_msgs_msg_ReswarmStatusPrimary_common, MATLABROSMsgInterface<reswarm_msgs::ReswarmStatusPrimary>)
CLASS_LOADER_REGISTER_CLASS(reswarm_msgs_ReswarmStatusPrimary_message, ROSMsgElementInterfaceFactory)
#ifdef _MSC_VER
#pragma warning(pop)
#else
