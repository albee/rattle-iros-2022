...
// Common copy functions for reswarm_msgs/ReswarmStatusSecondary
...
class RESWARM_MSGS_EXPORT reswarm_msgs_msg_ReswarmStatusSecondary_common : public MATLABROSMsgInterface<reswarm_msgs::ReswarmStatusSecondary> {
  public:
    virtual ~reswarm_msgs_msg_ReswarmStatusSecondary_common(){}
    virtual void copy_from_struct(reswarm_msgs::ReswarmStatusSecondary* msg, const matlab::data::Struct& arr, MultiLibLoader loader); 
    //----------------------------------------------------------------------------
    virtual MDArray_T get_arr(MDFactory_T& factory, const reswarm_msgs::ReswarmStatusSecondary* msg, MultiLibLoader loader, size_t size = 1);
};
  void reswarm_msgs_msg_ReswarmStatusSecondary_common::copy_from_struct(reswarm_msgs::ReswarmStatusSecondary* msg, const matlab::data::Struct& arr,
  ...
  //----------------------------------------------------------------------------
  MDArray_T reswarm_msgs_msg_ReswarmStatusSecondary_common::get_arr(MDFactory_T& factory, const reswarm_msgs::ReswarmStatusSecondary* msg,
    ...
    outArray[ctr]["MessageType"] = factory.createCharArray("reswarm_msgs/ReswarmStatusSecondary");
    // stamp
...
class RESWARM_MSGS_EXPORT reswarm_msgs_ReswarmStatusSecondary_message : public ROSMsgElementInterfaceFactory {
  public:
    virtual ~reswarm_msgs_ReswarmStatusSecondary_message(){}
    virtual std::shared_ptr<MATLABPublisherInterface> generatePublisherInterface(ElementType type);
    virtual std::shared_ptr<MATLABSubscriberInterface> generateSubscriberInterface(ElementType type);
};  
  std::shared_ptr<MATLABPublisherInterface> 
          reswarm_msgs_ReswarmStatusSecondary_message::generatePublisherInterface(ElementType type){
    if(type != eMessage){
        throw std::invalid_argument("Wrong input, Expected eMessage");
    }
    return std::make_shared<ROSPublisherImpl<reswarm_msgs::ReswarmStatusSecondary,reswarm_msgs_msg_ReswarmStatusSecondary_common>>();
  }
  std::shared_ptr<MATLABSubscriberInterface> 
         reswarm_msgs_ReswarmStatusSecondary_message::generateSubscriberInterface(ElementType type){
    if(type != eMessage){
        throw std::invalid_argument("Wrong input, Expected eMessage");
    }
    return std::make_shared<ROSSubscriberImpl<reswarm_msgs::ReswarmStatusSecondary,reswarm_msgs::ReswarmStatusSecondary::ConstPtr,reswarm_msgs_msg_ReswarmStatusSecondary_common>>();
  }
#include "class_loader/register_macro.hpp"
// Register the component with class_loader.
// This acts as a sort of entry point, allowing the component to be discoverable when its library
// is being loaded into a running process.
CLASS_LOADER_REGISTER_CLASS(reswarm_msgs_msg_ReswarmStatusSecondary_common, MATLABROSMsgInterface<reswarm_msgs::ReswarmStatusSecondary>)
CLASS_LOADER_REGISTER_CLASS(reswarm_msgs_ReswarmStatusSecondary_message, ROSMsgElementInterfaceFactory)
#ifdef _MSC_VER
#pragma warning(pop)
#else
