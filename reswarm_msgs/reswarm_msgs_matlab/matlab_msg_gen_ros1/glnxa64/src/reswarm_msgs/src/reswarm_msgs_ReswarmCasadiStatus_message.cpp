...
// Common copy functions for reswarm_msgs/ReswarmCasadiStatus
...
class RESWARM_MSGS_EXPORT reswarm_msgs_msg_ReswarmCasadiStatus_common : public MATLABROSMsgInterface<reswarm_msgs::ReswarmCasadiStatus> {
  public:
    virtual ~reswarm_msgs_msg_ReswarmCasadiStatus_common(){}
    virtual void copy_from_struct(reswarm_msgs::ReswarmCasadiStatus* msg, const matlab::data::Struct& arr, MultiLibLoader loader); 
    //----------------------------------------------------------------------------
    virtual MDArray_T get_arr(MDFactory_T& factory, const reswarm_msgs::ReswarmCasadiStatus* msg, MultiLibLoader loader, size_t size = 1);
};
  void reswarm_msgs_msg_ReswarmCasadiStatus_common::copy_from_struct(reswarm_msgs::ReswarmCasadiStatus* msg, const matlab::data::Struct& arr,
  ...
  //----------------------------------------------------------------------------
  MDArray_T reswarm_msgs_msg_ReswarmCasadiStatus_common::get_arr(MDFactory_T& factory, const reswarm_msgs::ReswarmCasadiStatus* msg,
    ...
    outArray[ctr]["MessageType"] = factory.createCharArray("reswarm_msgs/ReswarmCasadiStatus");
    // stamp
...
class RESWARM_MSGS_EXPORT reswarm_msgs_ReswarmCasadiStatus_message : public ROSMsgElementInterfaceFactory {
  public:
    virtual ~reswarm_msgs_ReswarmCasadiStatus_message(){}
    virtual std::shared_ptr<MATLABPublisherInterface> generatePublisherInterface(ElementType type);
    virtual std::shared_ptr<MATLABSubscriberInterface> generateSubscriberInterface(ElementType type);
};  
  std::shared_ptr<MATLABPublisherInterface> 
          reswarm_msgs_ReswarmCasadiStatus_message::generatePublisherInterface(ElementType type){
    if(type != eMessage){
        throw std::invalid_argument("Wrong input, Expected eMessage");
    }
    return std::make_shared<ROSPublisherImpl<reswarm_msgs::ReswarmCasadiStatus,reswarm_msgs_msg_ReswarmCasadiStatus_common>>();
  }
  std::shared_ptr<MATLABSubscriberInterface> 
         reswarm_msgs_ReswarmCasadiStatus_message::generateSubscriberInterface(ElementType type){
    if(type != eMessage){
        throw std::invalid_argument("Wrong input, Expected eMessage");
    }
    return std::make_shared<ROSSubscriberImpl<reswarm_msgs::ReswarmCasadiStatus,reswarm_msgs::ReswarmCasadiStatus::ConstPtr,reswarm_msgs_msg_ReswarmCasadiStatus_common>>();
  }
#include "class_loader/register_macro.hpp"
// Register the component with class_loader.
// This acts as a sort of entry point, allowing the component to be discoverable when its library
// is being loaded into a running process.
CLASS_LOADER_REGISTER_CLASS(reswarm_msgs_msg_ReswarmCasadiStatus_common, MATLABROSMsgInterface<reswarm_msgs::ReswarmCasadiStatus>)
CLASS_LOADER_REGISTER_CLASS(reswarm_msgs_ReswarmCasadiStatus_message, ROSMsgElementInterfaceFactory)
#ifdef _MSC_VER
#pragma warning(pop)
#else
