...
%ReswarmStatusPrimary gives an empty data for reswarm_msgs/ReswarmStatusPrimary
% Copyright 2019-2020 The MathWorks, Inc.
%#codegen
data = struct();
data.MessageType = 'reswarm_msgs/ReswarmStatusPrimary';
...
info.MessageType = 'reswarm_msgs/ReswarmStatusPrimary';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
