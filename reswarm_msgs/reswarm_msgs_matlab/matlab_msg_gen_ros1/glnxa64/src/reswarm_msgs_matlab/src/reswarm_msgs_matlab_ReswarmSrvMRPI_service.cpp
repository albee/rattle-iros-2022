...
// Common copy functions for reswarm_msgs_matlab/ReswarmSrvMRPIRequest
...
#endif //_MSC_VER
#include "ros/ros.h"
#include "reswarm_msgs_matlab/ReswarmSrvMRPI.h"
#include "visibility_control.h"
#include "class_loader/multi_library_class_loader.hpp"
#include "ROSPubSubTemplates.hpp"
#include "ROSServiceTemplates.hpp"
class RESWARM_MSGS_MATLAB_EXPORT reswarm_msgs_matlab_msg_ReswarmSrvMRPIRequest_common : public MATLABROSMsgInterface<reswarm_msgs_matlab::ReswarmSrvMRPI::Request> {
  public:
    virtual ~reswarm_msgs_matlab_msg_ReswarmSrvMRPIRequest_common(){}
    virtual void copy_from_struct(reswarm_msgs_matlab::ReswarmSrvMRPI::Request* msg, const matlab::data::Struct& arr, MultiLibLoader loader); 
    //----------------------------------------------------------------------------
    virtual MDArray_T get_arr(MDFactory_T& factory, const reswarm_msgs_matlab::ReswarmSrvMRPI::Request* msg, MultiLibLoader loader, size_t size = 1);
};
  void reswarm_msgs_matlab_msg_ReswarmSrvMRPIRequest_common::copy_from_struct(reswarm_msgs_matlab::ReswarmSrvMRPI::Request* msg, const matlab::data::Struct& arr,
  ...
  //----------------------------------------------------------------------------
  MDArray_T reswarm_msgs_matlab_msg_ReswarmSrvMRPIRequest_common::get_arr(MDFactory_T& factory, const reswarm_msgs_matlab::ReswarmSrvMRPI::Request* msg,
       MultiLibLoader loader, size_t size) {
    auto outArray = factory.createStructArray({size,1},{"MessageType","W","UMax","Dt","Mass","QPosAnc","QVelAnc","RAnc"});
    for(size_t ctr = 0; ctr < size; ctr++){
    outArray[ctr]["MessageType"] = factory.createCharArray("reswarm_msgs_matlab/ReswarmSrvMRPIRequest");
    // w
...
class RESWARM_MSGS_MATLAB_EXPORT reswarm_msgs_matlab_msg_ReswarmSrvMRPIResponse_common : public MATLABROSMsgInterface<reswarm_msgs_matlab::ReswarmSrvMRPI::Response> {
  public:
    virtual ~reswarm_msgs_matlab_msg_ReswarmSrvMRPIResponse_common(){}
    virtual void copy_from_struct(reswarm_msgs_matlab::ReswarmSrvMRPI::Response* msg, const matlab::data::Struct& arr, MultiLibLoader loader); 
    //----------------------------------------------------------------------------
    virtual MDArray_T get_arr(MDFactory_T& factory, const reswarm_msgs_matlab::ReswarmSrvMRPI::Response* msg, MultiLibLoader loader, size_t size = 1);
};
  void reswarm_msgs_matlab_msg_ReswarmSrvMRPIResponse_common::copy_from_struct(reswarm_msgs_matlab::ReswarmSrvMRPI::Response* msg, const matlab::data::Struct& arr,
               MultiLibLoader loader) {
    try {
        //K
  ...
  //----------------------------------------------------------------------------
  MDArray_T reswarm_msgs_matlab_msg_ReswarmSrvMRPIResponse_common::get_arr(MDFactory_T& factory, const reswarm_msgs_matlab::ReswarmSrvMRPI::Response* msg,
       MultiLibLoader loader, size_t size) {
    auto outArray = factory.createStructArray({size,1},{"MessageType","K","Au","Bu","AZ","BZ"});
    for(size_t ctr = 0; ctr < size; ctr++){
    outArray[ctr]["MessageType"] = factory.createCharArray("reswarm_msgs_matlab/ReswarmSrvMRPIResponse");
    // K
...
class RESWARM_MSGS_MATLAB_EXPORT reswarm_msgs_matlab_ReswarmSrvMRPI_service : public ROSMsgElementInterfaceFactory {
  public:
    virtual ~reswarm_msgs_matlab_ReswarmSrvMRPI_service(){}
  ...
  std::shared_ptr<MATLABPublisherInterface> 
          reswarm_msgs_matlab_ReswarmSrvMRPI_service::generatePublisherInterface(ElementType type){
    std::shared_ptr<MATLABPublisherInterface> ptr;
    if(type == eRequest){
        ptr = std::make_shared<ROSPublisherImpl<reswarm_msgs_matlab::ReswarmSrvMRPI::Request,reswarm_msgs_matlab_msg_ReswarmSrvMRPIRequest_common>>();
    }else if(type == eResponse){
        ptr = std::make_shared<ROSPublisherImpl<reswarm_msgs_matlab::ReswarmSrvMRPI::Response,reswarm_msgs_matlab_msg_ReswarmSrvMRPIResponse_common>>();
    }else{
  ...
  std::shared_ptr<MATLABSubscriberInterface> 
          reswarm_msgs_matlab_ReswarmSrvMRPI_service::generateSubscriberInterface(ElementType type){
    std::shared_ptr<MATLABSubscriberInterface> ptr;
    if(type == eRequest){
        ptr = std::make_shared<ROSSubscriberImpl<reswarm_msgs_matlab::ReswarmSrvMRPI::Request,reswarm_msgs_matlab::ReswarmSrvMRPI::Request::ConstPtr,reswarm_msgs_matlab_msg_ReswarmSrvMRPIRequest_common>>();
    }else if(type == eResponse){
        ptr = std::make_shared<ROSSubscriberImpl<reswarm_msgs_matlab::ReswarmSrvMRPI::Response,reswarm_msgs_matlab::ReswarmSrvMRPI::Response::ConstPtr,reswarm_msgs_matlab_msg_ReswarmSrvMRPIResponse_common>>();
    }else{
        throw std::invalid_argument("Wrong input, Expected 'Request' or 'Response'");
    }
    return ptr;
  ...
  std::shared_ptr<MATLABSvcServerInterface> 
          reswarm_msgs_matlab_ReswarmSrvMRPI_service::generateSvcServerInterface(){
    return std::make_shared<ROSSvcServerImpl<reswarm_msgs_matlab::ReswarmSrvMRPI::Request,reswarm_msgs_matlab::ReswarmSrvMRPI::Response,reswarm_msgs_matlab_msg_ReswarmSrvMRPIRequest_common,reswarm_msgs_matlab_msg_ReswarmSrvMRPIResponse_common>>();
  }
  std::shared_ptr<MATLABSvcClientInterface> 
          reswarm_msgs_matlab_ReswarmSrvMRPI_service::generateSvcClientInterface(){
    return std::make_shared<ROSSvcClientImpl<reswarm_msgs_matlab::ReswarmSrvMRPI,reswarm_msgs_matlab::ReswarmSrvMRPI::Request,reswarm_msgs_matlab::ReswarmSrvMRPI::Response,reswarm_msgs_matlab_msg_ReswarmSrvMRPIRequest_common,reswarm_msgs_matlab_msg_ReswarmSrvMRPIResponse_common>>();
  }
#include "class_loader/register_macro.hpp"
// Register the component with class_loader.
// This acts as a sort of entry point, allowing the component to be discoverable when its library
// is being loaded into a running process.
CLASS_LOADER_REGISTER_CLASS(reswarm_msgs_matlab_msg_ReswarmSrvMRPIRequest_common, MATLABROSMsgInterface<reswarm_msgs_matlab::ReswarmSrvMRPI::Request>)
CLASS_LOADER_REGISTER_CLASS(reswarm_msgs_matlab_msg_ReswarmSrvMRPIResponse_common, MATLABROSMsgInterface<reswarm_msgs_matlab::ReswarmSrvMRPI::Response>)
CLASS_LOADER_REGISTER_CLASS(reswarm_msgs_matlab_ReswarmSrvMRPI_service, ROSMsgElementInterfaceFactory)
#ifdef _MSC_VER
#pragma warning(pop)
#else
