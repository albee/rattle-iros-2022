// Generated by gencpp from file reswarm_msgs/ReswarmCasadiDebug.msg
// DO NOT EDIT!


#ifndef RESWARM_MSGS_MESSAGE_RESWARMCASADIDEBUG_H
#define RESWARM_MSGS_MESSAGE_RESWARMCASADIDEBUG_H
...
struct ReswarmCasadiDebug_
{
  ...
  typedef boost::shared_ptr< ::reswarm_msgs::ReswarmCasadiDebug_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::reswarm_msgs::ReswarmCasadiDebug_<ContainerAllocator> const> ConstPtr;

}; // struct ReswarmCasadiDebug_

typedef ::reswarm_msgs::ReswarmCasadiDebug_<std::allocator<void> > ReswarmCasadiDebug;

typedef boost::shared_ptr< ::reswarm_msgs::ReswarmCasadiDebug > ReswarmCasadiDebugPtr;
typedef boost::shared_ptr< ::reswarm_msgs::ReswarmCasadiDebug const> ReswarmCasadiDebugConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::reswarm_msgs::ReswarmCasadiDebug_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::reswarm_msgs::ReswarmCasadiDebug_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::reswarm_msgs::ReswarmCasadiDebug_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::reswarm_msgs::ReswarmCasadiDebug_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::reswarm_msgs::ReswarmCasadiDebug_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::reswarm_msgs::ReswarmCasadiDebug_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::reswarm_msgs::ReswarmCasadiDebug_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::reswarm_msgs::ReswarmCasadiDebug_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::reswarm_msgs::ReswarmCasadiDebug_<ContainerAllocator> >
{
  ...
  static const char* value(const ::reswarm_msgs::ReswarmCasadiDebug_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x71a2da2130cb8705ULL;
  static const uint64_t static_value2 = 0xdacf80ff5c94f1b9ULL;
};

template<class ContainerAllocator>
struct DataType< ::reswarm_msgs::ReswarmCasadiDebug_<ContainerAllocator> >
{
  static const char* value()
  {
    return "reswarm_msgs/ReswarmCasadiDebug";
  }
...
template<class ContainerAllocator>
struct Definition< ::reswarm_msgs::ReswarmCasadiDebug_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::reswarm_msgs::ReswarmCasadiDebug_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::reswarm_msgs::ReswarmCasadiDebug_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::reswarm_msgs::ReswarmCasadiDebug_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // RESWARM_MSGS_MESSAGE_RESWARMCASADIDEBUG_H
