...
acadoWorkspace.rk_diffsNew2[(i * 19) + (run1)] += + acadoWorkspace.rk_diffK[i * 2]*(real_t)2.5000000000000000e-01 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)2.5000000000000000e-01;
}
}
...
for (i = 0; i < 13; ++i)
{
acadoWorkspace.rk_diffsNew2[(i * 19) + (run1 + 13)] = + acadoWorkspace.rk_diffK[i * 2]*(real_t)2.5000000000000000e-01 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)2.5000000000000000e-01;
}
}
