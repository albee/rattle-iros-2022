...
/** Matrix of size: 11 x 29 (row major format)
 * 
...
/** Matrix of size: 2 x 247 (row major format) */
...
/** Matrix of size: 130 x 6 (row major format) */
real_t evGu[ 780 ];

/** Column vector of size: 210 */
real_t objAuxVar[ 210 ];

/** Row vector of size: 48 */
real_t objValueIn[ 48 ];
...
/** Matrix of size: 130 x 18 (row major format) */
real_t Q2[ 2340 ];

/** Matrix of size: 60 x 6 (row major format) */
real_t R1[ 360 ];

/** Matrix of size: 60 x 18 (row major format) */
real_t R2[ 1080 ];
...
/** Matrix of size: 715 x 6 (row major format) */
real_t E[ 4290 ];
 ...
 *
 *  \param rk_eta Working array of size 48 to pass the input values and return the results.
